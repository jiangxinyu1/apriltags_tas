...
(cl:defclass <AprilTagDetections> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (detections
    :reader detections
    :initarg :detections
    :type (cl:vector apriltags_msgs-msg:AprilTag)
   :initform (cl:make-array 0 :element-type 'apriltags_msgs-msg:AprilTag :initial-element (cl:make-instance 'apriltags_msgs-msg:AprilTag))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <AprilTagDetections>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AprilTagDetections)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name apriltags_msgs-msg:<AprilTagDetections> is deprecated: use apriltags_msgs-msg:AprilTagDetections instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <AprilTagDetections>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader apriltags_msgs-msg:header-val is deprecated.  Use apriltags_msgs-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'detections-val :lambda-list '(m))
(cl:defmethod detections-val ((m <AprilTagDetections>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader apriltags_msgs-msg:detections-val is deprecated.  Use apriltags_msgs-msg:detections instead.")
  (detections m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <AprilTagDetections>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'detections)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'apriltags_msgs-msg:AprilTag))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AprilTagDetections>)))
  ...
  "apriltags_msgs/AprilTagDetections")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AprilTagDetections)))
  "Returns string type for a message object of type 'AprilTagDetections"
  "apriltags_msgs/AprilTagDetections")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<AprilTagDetections>)))
  ...
  "d4bc35daf77e797dc95ce1f2fcc1ea5d")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'AprilTagDetections)))
  "Returns md5sum for a message object of type 'AprilTagDetections"
  "d4bc35daf77e797dc95ce1f2fcc1ea5d")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<AprilTagDetections>)))
  ...
  (cl:format cl:nil "Header header~%AprilTag[] detections~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: apriltags_msgs/AprilTag~%string id~%geometry_msgs/Point[] corners_px~%geometry_msgs/Pose pose_3d~%bool pose_valid~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'AprilTagDetections)))
  "Returns full string definition for message of type 'AprilTagDetections"
  (cl:format cl:nil "Header header~%AprilTag[] detections~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: apriltags_msgs/AprilTag~%string id~%geometry_msgs/Point[] corners_px~%geometry_msgs/Pose pose_3d~%bool pose_valid~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
